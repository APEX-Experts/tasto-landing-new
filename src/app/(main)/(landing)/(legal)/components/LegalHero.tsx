import { BrandText } from "@/components/landing/layout/brand-formatter";
...
export function LegalHero({ title, explanation }: LegalHeroProps) {
  return (
    <div className="mb-12 text-center md:text-left flex flex-col items-center md:items-start">
      ...
      <div className="text-lg md:text-xl leading-relaxed text-tasto-white/80 max-w-3xl font-light mx-auto md:mx-0">
        <BrandText text={explanation} logoClassName="md:mr-1" />
      </div>
